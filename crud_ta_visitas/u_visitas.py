...
class AlterarVisitas:
    def __init__(self, janela_mestre, idt):
        ...
        #Título
        titulo = tk.Label(self.popup, text="Alterar Visita", font='Helvetica 16 bold', fg='blue')
        ...
        #Data de visita
        lb_data = tk.Label(self.popup, text="Data de visita", font='Helvetica 12 bold', fg='blue')
        lb_data.grid(row=5, column=0, padx=PADX, pady=PADY)

        self.valor_data = tk.StringVar()
        self.valor_data.set((funcao['dta_visita']))
        self.et_data = DateEntry(self.popup, textvariable=self.valor_data, font='Helvetica 16 bold', foreground='green',
        ...
        #Hora de saída
        lb_hra_saida = tk.Label(self.popup, text="Hora de saída", font='Helvetica 12 bold', fg='blue')
        ...
        #Alterar visitante
        lb_visitante = tk.Label(self.popup, text="Codigo do Visitante", font='Helvetica 12 bold', fg='blue')
        ...
        #Alterar Campus
        lb_campus = tk.Label(self.popup, text="Codigo do campus", font='Helvetica 12 bold', fg='blue')
